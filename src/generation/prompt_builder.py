...
def _get_format_instruction(benchmark: str) -> str:
    ...
    instructions = {
        ...
        "mpdocvqa": (
            ...
            "ALWAYS give your single best answer extracted from the context -- "
            "never reply 'no information', 'not available', 'cannot find', or "
            "that the document lacks the answer. Every question is answerable "
            "from the excerpts; commit to the most likely value. "
            "Examples -- "
