...
cells.append(code(
    ...
    "\n"
    "import sys, pathlib\n"
    "ROOT = pathlib.Path('.').resolve().parent   # gramm-rag/ project root\n"
    ...
    "# Derived artefacts now live INSIDE mpdocvqa_benchmark/ (self-contained).\n"
    "# Raw inputs stay at gramm-rag/data/mpdocvqa/ since they are shared input.\n"
    "PARSED_DIR  = pathlib.Path('parsed')\n"
    "EMB_DIR     = pathlib.Path('embeddings')\n"
    "GRAPH_DIR   = pathlib.Path('graphs')\n"
    "MODEL_DIR   = pathlib.Path('results') / 'models'\n"
