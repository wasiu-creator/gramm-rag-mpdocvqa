...
cells.append(code(
    ...
    "# Cross-encoder reranker. NOTE: empirically WORSE than the bi-encoder for\n"
    "# this fine-grained-OCR + page-aware pipeline (GraMM 0.536 vs 0.593),\n"
    "# because page selection then feeds the whole page anyway -- the chunk-\n"
    "# level precision is discarded. Kept configurable; default OFF.\n"
